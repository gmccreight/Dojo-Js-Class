function HackerFair_xmlhttpRequester(unsafeContentWin, chromeWindow)  {
...
HackerFair_xmlhttpRequester.prototype.contentStartRequest = function(details)  {
  ...
  switch (scheme) {
    ...
    case "ftp":
      this.chromeWindow.setTimeout(
        HackerFairGM.hitch(this, "chromeStartRequest", url, details), 0);
      break;
    default:
...
HackerFair_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
HackerFair_xmlhttpRequester.prototype.setupRequestEvent =
function(unsafeContentWin, req, event, details) {
  if (details[event]) {
    req[event] = function() {
      ...
      return new XPCNativeWrapper(unsafeContentWin, "setTimeout()").setTimeout(function(){details[event](responseState);}, 0);
    };
  }
};