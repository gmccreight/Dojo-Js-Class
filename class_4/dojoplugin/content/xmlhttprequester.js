function Dojo_xmlhttpRequester(unsafeContentWin, chromeWindow)  {
...
Dojo_xmlhttpRequester.prototype.contentStartRequest = function(details)  {
  ...
  switch (scheme) {
    ...
    case "ftp":
      this.chromeWindow.setTimeout(
        DojoGM.hitch(this, "chromeStartRequest", url, details), 0);
      break;
    default:
...
Dojo_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
Dojo_xmlhttpRequester.prototype.setupRequestEvent =
